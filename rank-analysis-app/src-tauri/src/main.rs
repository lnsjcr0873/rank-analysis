...
fn main() -> std::result::Result<(), Box<dyn std::error::Error>> {
    ...
    let mut app_builder = tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            command::opgg::get_aram_champion_builds,
            ...
            command::mayhem::mayhem_crowdsourced_augment_stats,
            ...
            command::mayhem::mayhem_ocr_status,
            command::mayhem::mayhem_ocr_prewarm,
            ...
            command::overlay::clear_overlay_panel,
